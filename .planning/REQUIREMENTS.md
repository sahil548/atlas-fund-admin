...
- [x] **LP-04**: Capital account statement has period/date range picker
...
- [x] **AI-02**: Command bar supports action execution (create deal, log note, assign task, trigger report) without navigation
- [x] **AI-03**: AI can auto-extract deal terms from uploaded CIMs/documents
