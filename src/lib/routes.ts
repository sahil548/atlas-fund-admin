...
export const APP_ROUTES: AppRoute[] = [
  ...
  { path: "/transactions", label: "Capital Activity", description: "Capital calls, distributions, and waterfall analysis", keywords: ["capital", "transactions", "calls", "distributions", "waterfall", "capital calls", "capital activity"], icon: "DollarSign", sidebarIcon: "\u25C7", portal: "gp", priority: 78 },
