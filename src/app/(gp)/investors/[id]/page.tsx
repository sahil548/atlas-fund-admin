          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div className="divide-y divide-gray-50 dark:divide-gray-700">
              {(inv.capitalCallLineItems || [])
                ...
                .sort((a: { capitalCall: { callDate: string } }, b: { capitalCall: { callDate: string } }) => new Date(b.capitalCall.callDate).getTime() - new Date(a.capitalCall.callDate).getTime())
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div className="divide-y divide-gray-50 dark:divide-gray-700">
              {(inv.distributionLineItems || [])
                ...
                .sort((a: { distribution: { distributionDate: string } }, b: { distribution: { distributionDate: string } }) => new Date(b.distribution.distributionDate).getTime() - new Date(a.distribution.distributionDate).getTime())
